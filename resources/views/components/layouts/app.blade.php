	...
	<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
		<div class="container">
			<a class="navbar-brand" wire:navigate href="{{route('home')}}">
				<img loading="prelaod" decoding="async" class="img-fluid" width="160" src="{{ asset('front/images/av-logo.jpeg') }}" alt="Wallet">
			</a>
		...
		<div class="row justify-content-between">
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="list-inline-item me-4"><a class="text-black" href="{{ route('page',1) }} wire:navigate">Privacy Policy</a>
                        </li>
